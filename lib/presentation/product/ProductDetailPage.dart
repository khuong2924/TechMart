...
import 'package:tech_mart/core/utils/token_storage.dart';
                ...
                ? Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        flex: 4,
                        child: Padding(
                          padding: const EdgeInsets.only(left: 32, top: 32, bottom: 32, right: 16),
                          child: AspectRatio(
                            aspectRatio: 1,
                            child: Container(
                      ...
                      Expanded(
                        flex: 6,
                        child: Padding(
                          padding: const EdgeInsets.only(right: 32, top: 32, bottom: 32, left: 16),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Product Name
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: isSmallScreen ? 16 : (isMediumScreen ? 24 : 48)),
                                child: Row(
                                  children: [
                                    Expanded(
